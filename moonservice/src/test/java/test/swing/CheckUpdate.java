...
/**
 * Created by maguoqiang on 2016/3/22.
 */
...
public class CheckUpdate extends JFrame {
    ...
    private class Check extends Thread {
        ...
        String netVersion;
        //本地版本文件名
        String LocalVerFileName = "E:/myproject/ver.txt";
        ...
        public void run() {
            //更新文件版本标识URL
            String versionUrl = "http://www.baidu.com";
...
*/
            ...
            try {
                ...
                String netVerStr = "1.1";
                String localVerStr = "1.2";
            ...
            if (isUpdated) {
                ...
                //网络上的文件位置
                String updateUrl =
                        "http://192.168.0.4/public/189/leya920-1.0-SNAPSHOT.war";
