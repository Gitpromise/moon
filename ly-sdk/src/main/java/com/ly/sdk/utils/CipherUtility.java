...
public class CipherUtility {
     ...
     * <h1>AES对称加密算法</h1>
     * <hr>
     * 这里演示的是其Java6.0的实现,理所当然的BouncyCastle也支持AES对称加密算，另外,我们也可以以AES算法实现为参考,完成RC2,
     * RC4和Blowfish算法的实现
     * <hr>
     ...
     * Jurisdiction Policy Files 6,<br>
     * 点击下载
     * http://download.oracle.com/otn-pub/java/jce_policy/6/jce_policy-6.zip<br>
    ...
    public static class AES {
        ...
        protected static Key getKey(String password) throws Exception {
            ...
            return new SecretKeySpec(DigestUtils.md5(password.getBytes()), KEY_ALGORITHM); // MD5 128bit
        }
        ...
        public static String encrypt(String data) {
            return encrypt(data, getDefaultKey(), true);
        }
         ...
         * @return 加密后的数据
         */
        public static String encrypt(String data, String key, boolean urlSafe) {
            try {
                Key k = getKey(key);// 还原密钥
        ...
        public static String decrypt(String data) {
            try {
                Key k = getKey(getDefaultKey()); // 还原密钥
        ...
        public static String getDefaultKey() {
            return EnvProperties.get(DEFAULT_PRIVATE_KEY);
        }
    }

    /**
     *
     * @param propertyName 要替换的属性值
     * @return 返回是否加密过 true是 false 不是
     */
    public static boolean isEncryptProp(String propertyName, String[] encryPropertieNames) {
        for (String encryptName : encryPropertieNames) {
